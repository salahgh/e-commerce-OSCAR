    ...
    return (
      <View style={[styles.container, { paddingTop: insets.top }]}>
        <View style={styles.header}>
          ...
          <Text style={[styles.headerTitle, { fontFamily: fontFamily.medium }]}>{t('cart.title')}</Text>
          <View style={{ width: 24 }} />
        </View>
        <EmptyState
          icon="cart-outline"
      ...
      <View style={styles.itemDetails}>
        ...
        <View style={styles.itemBottomRow}>
          ...
          <View style={styles.quantitySelector}>
            ...
            <Text style={[styles.qtyValue, { fontFamily: fontFamily.medium }]}>{item.quantity}</Text>
            <TouchableOpacity
              style={styles.qtyBtn}
              onPress={() => handleUpdateQuantity(item.id, item.quantity + 1)}
            >
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={[styles.bottomSection, { paddingBottom: insets.bottom + spacing.md }]}>
        ...
        <View style={styles.summaryRow}>
          <Text style={[styles.summaryLabel, { fontFamily: fontFamily.medium }]}>{t('cart.total')}:</Text>
          <Text style={[styles.summaryValue, { fontFamily: fontFamily.medium }]}>{subTotal} DZD</Text>
        </View>
        <View style={styles.summaryRow}>
          <Text style={[styles.reductionLabel, { fontFamily: fontFamily.regular }]}>{t('cart.reduction')}:</Text>
        ...
        <View style={[styles.summaryRow, styles.totalAfterRow]}>
          <Text style={[styles.totalLabel, { fontFamily: fontFamily.bold }]}>{t('cart.totalAfterDiscount')}:</Text>
        ...
        <TouchableOpacity style={styles.checkoutButton} onPress={handleCheckout} activeOpacity={0.8}>
          <Text style={[styles.checkoutButtonText, { fontFamily: fontFamily.medium }]}>{t('common.continue')}</Text>

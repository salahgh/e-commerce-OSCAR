      ...
      <View style={styles.actions}>
        {!isDefault && (
          <TouchableOpacity onPress={onSetDefault} accessibilityRole="button">
            <Text style={styles.action}>{t('address.makeDefault', 'Set default')}</Text>
          </TouchableOpacity>
        )}
        <TouchableOpacity onPress={onEdit} accessibilityRole="button">
          <Text style={styles.action}>{t('common.edit', 'Edit')}</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={onDelete} accessibilityRole="button">
          <Text style={[styles.action, styles.danger]}>{t('common.delete', 'Delete')}</Text>
        </TouchableOpacity>
      </View>
    </View>
  );

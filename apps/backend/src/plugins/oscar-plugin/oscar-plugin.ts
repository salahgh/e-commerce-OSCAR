 ...
 * - Home / office delivery methods priced per wilaya from the back-office (shipping/)
...
@VendurePlugin({
  ...
  providers: [OscarService, DashboardService, WilayaShippingService, OrderWilayaService, ShippingSetupService],

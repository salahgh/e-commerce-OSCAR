...
export default function ErrorBoundary({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-32 text-center">
      <p className="text-12 uppercase tracking-wide text-state-danger-content">{t('errorEyebrow')}</p>
      <h1 className="mt-4 text-36 font-bold text-content-strong">{t('error')}</h1>

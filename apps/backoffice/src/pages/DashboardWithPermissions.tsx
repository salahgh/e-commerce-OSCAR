...
export const Dashboard: React.FC = () => {
  ...
  // Permission checks
  const canReadOrders = hasPermission('ReadOrder');
  const canReadCustomers = hasPermission('ReadCustomer');
  const canReadCatalog = hasPermission('ReadCatalog');
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        {canReadCatalog ? (
          ...
          <LockedSection title="Alertes Stock" permission="ReadCatalog" />
        )}
      </div>
      ...
      <div className="bg-card rounded-xl border border-border p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          {canReadOrders ? (
            ...
            <LockedQuickAction
              icon={<ShoppingCart className="h-8 w-8 text-green-400 mb-2 opacity-50" />}
              label="Commandes"
              permission="ReadOrder"
          ...
          {canReadCustomers ? (
            ...
            <LockedQuickAction
              icon={<Users className="h-8 w-8 text-purple-400 mb-2 opacity-50" />}
              label="Clients"

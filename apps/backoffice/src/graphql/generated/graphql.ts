...
export type CreateCollectionMutation = { __typename?: 'Mutation', createCollection: { __typename?: 'Collection', id: string, name: string, slug: string, description: string, isPrivate: boolean, position: number, parentId: string, translations: Array<{ __typename?: 'CollectionTranslation', languageCode: LanguageCode, name: string, slug: string, description: string }>, customFields?: { __typename?: 'CollectionCustomFields', displayOrder?: number | null } | null } };

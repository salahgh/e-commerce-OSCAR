...
export type AdminProductsQuery = { __typename?: 'Query', products: { __typename?: 'ProductList', totalItems: number, items: Array<{ __typename?: 'Product', id: string, createdAt: any, updatedAt: any, name: string, slug: string, description: string, enabled: boolean, featuredAsset?: { __typename?: 'Asset', id: string, name: string, preview: string, source: string } | null, assets: Array<{ __typename?: 'Asset', id: string, name: string, preview: string, source: string }>, variants: Array<{ __typename?: 'ProductVariant', id: string, name: string, sku: string, price: any, priceWithTax: any, stockOnHand: number, stockAllocated: number, enabled: boolean, options: Array<{ __typename?: 'ProductOption', id: string, code: string, name: string }>, facetValues: Array<{ __typename?: 'FacetValue', id: string, name: string, code: string, facet: { __typename?: 'Facet', id: string, name: string, code: string } }>, customFields?: { __typename?: 'ProductVariantCustomFields', minStockAlert?: number | null } | null }>, optionGroups: Array<{ __typename?: 'ProductOptionGroup', id: string, code: string, name: string, options: Array<{ __typename?: 'ProductOption', id: string, code: string, name: string }> }>, facetValues: Array<{ __typename?: 'FacetValue', id: string, name: string, code: string, facet: { __typename?: 'Facet', id: string, name: string, code: string } }>, collections: Array<{ __typename?: 'Collection', id: string, name: string, slug: string, parent?: { __typename?: 'Collection', id: string, name: string } | null }>, translations: Array<{ __typename?: 'ProductTranslation', languageCode: LanguageCode, name: string, slug: string, description: string }> }> } };
...
export type UpdateProductVariantsMutation = { __typename?: 'Mutation', updateProductVariants: Array<{ __typename?: 'ProductVariant', id: string, name: string, sku: string, price: any, priceWithTax: any, stockOnHand: number, stockAllocated: number, enabled: boolean, trackInventory: GlobalFlag, featuredAsset?: { __typename?: 'Asset', id: string, preview: string } | null, options: Array<{ __typename?: 'ProductOption', id: string, code: string, name: string }>, customFields?: { __typename?: 'ProductVariantCustomFields', minStockAlert?: number | null } | null } | null> };
